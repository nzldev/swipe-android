...
import net.devsmine.swipeDroid.R.*
import net.devsmine.swipeDroid.animation.Direction.LEFT
import net.devsmine.swipeDroid.animation.LeftEdgeController
import net.devsmine.swipeDroid.animation.RightEdgeController

class SwipePager : ViewPager, ViewTreeObserver.OnDrawListener, ViewI {

    constructor(context: Context) : super(context)
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        buttonDrawableId = context.obtainStyledAttributes(attrs, styleable.LiquidPager)
            .getResourceId(styleable.LiquidPager_button_drawable, drawable.ic_button)
    }
    ...
    private var buttonDrawableId = drawable.ic_button
