package net.devsmine.swipeDroid.animation

import android.graphics.Canvas
import android.view.MotionEvent
import net.devsmine.swipeDroid.EdgeController
import net.devsmine.swipeDroid.ViewI
import net.devsmine.swipeDroid.animation.Direction.LEFT
import net.devsmine.swipeDroid.animation.Direction.RIGHT
